  ...
  return (
    <main className="visualHome">
      ...
      <section className="visualStory shell">
        ...
        <div className="audiencePaths">
          <Link href="/portfolio"><Image src="/screenshots/qira-discovery.svg" alt="Tampilan QIRA Discovery dengan form kebutuhan usaha" width={1600} height={900} unoptimized sizes="(max-width: 680px) 100vw, 33vw" /><span>QIRA Discovery</span><strong>Kebutuhan menjadi arah solusi yang jelas</strong><small>Data contoh · Lihat portofolio →</small></Link>
          <Link href="/portfolio"><Image src="/screenshots/qira-invoice-maker.svg" alt="Tampilan QIRA Invoice Maker dan pratinjau invoice" width={1600} height={900} unoptimized sizes="(max-width: 680px) 100vw, 33vw" /><span>Invoice Maker</span><strong>Input data sampai invoice siap digunakan</strong><small>Data contoh · Lihat portofolio →</small></Link>
          <Link href="/portfolio"><Image src="/screenshots/travel-transaction-demo.svg" alt="Tampilan aplikasi transaksi dan pratinjau nota thermal" width={1600} height={900} unoptimized sizes="(max-width: 680px) 100vw, 33vw" /><span>Transaksi & nota</span><strong>Input transaksi sampai nota thermal</strong><small>Identitas disamarkan · Lihat portofolio →</small></Link>
        </div>
