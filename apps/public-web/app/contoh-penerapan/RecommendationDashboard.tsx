...
const details: Record<string, Detail> = {
  ...
  "Kursus & Bimbingan Belajar":{users:["Pemilik lembaga","Admin","Pengajar"],pages:[{name:"Jadwal kelas",description:"Kelas, ruangan, pengajar, siswa, dan perubahan jadwal terlihat bersama."},{name:"Data siswa",description:"Kontak, program, orang tua, riwayat belajar, dan catatan tersimpan."},{name:"Absensi",description:"Pengajar mengisi kehadiran dengan cepat per pertemuan."},{name:"Tagihan",description:"Biaya program, jatuh tempo, dan status pembayaran dapat dipantau."}],automations:["Mengingatkan jadwal kelas","Menandai siswa yang sering tidak hadir","Mengingatkan tagihan belajar yang jatuh tempo"],day:[{time:"Pagi",activity:"Admin membuka jadwal",result:"Kelas dan pengajar hari itu terlihat."},{time:"Siang",activity:"Pengajar mengisi absensi",result:"Kehadiran siswa langsung tersimpan."},{time:"Sore",activity:"Pemilik melihat ringkasan",result:"Kelas, absensi, dan tagihan terpantau."}],records:["Siswa","Pengajar","Kelas","Absensi","Program","Tagihan"]},
