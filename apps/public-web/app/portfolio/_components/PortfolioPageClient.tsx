...
const ITEMS_ID: readonly PortfolioItem[] = [
  {
    number: "01",
    tag: "QIRA Product",
    title: "QIRA Discovery (Needs Mapping)",
  ...
  },
  {
    ...
    solution: "Editor terpadu dengan real-time preview sebelum dokumen PDF diterbitkan.",
    ...
    cta: "Konsultasi Sistem Invoicing",
  },
  {
    number: "03",
    ...
    solution: "Aplikasi POS ringan yang menyatukan checkout kasir, kalkulasi diskon, dan print nota thermal.",
    result: "Proses transaksi instan, rekap harian otomatis tersimpan rapi di cloud database.",
  ...
  },
  {
    ...
    problem: "Ribuan SKU bangunan dicatat manual di buku, rawan selisih stok dan rekap harian melelahkan.",
    solution: "Sistem kasir cloud dengan pencarian instan, auto-deduct inventaris, dan dashboard owner.",
    result: "Kecepatan kasir 10x lebih cepat, akurasi stok 0% error, dan rekap omset otomatis seketika.",
    visual: "Multi-SKU → Auto-Deduct → Cloud Sync",
