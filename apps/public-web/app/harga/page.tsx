...
export default function PricingPage() {
  return <main>
    <nav className="nav shell"><Link className="brand" href="/">QIRA<span>.</span></Link><div className="navLinks"><Link href="/coba-masalah">Coba Masalah</Link><Link href="/contoh-penerapan">Cara QIRA Membantu</Link><Link className="navCta" href="/discovery">Discovery</Link></div></nav>
