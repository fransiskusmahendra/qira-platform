...
export default function PricingPage() {
  return <main>
    ...
    <footer className="footer shell"><span>QIRA · PT Rays Solusi Informasi</span><span>Langkah berikutnya: cara QIRA membantu</span></footer>
  </main>;
}
