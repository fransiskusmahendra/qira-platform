...
export function PersonalizedDemo() {
  ...
  return <section className={styles.section} id="live-experience">
    ...
    </div>:<div className={styles.empty}><span>✦</span><p>Isi cerita singkat di atas. Dashboard ini akan berubah menjadi rekomendasi yang lebih sesuai untuk bisnismu.</p></div>}
