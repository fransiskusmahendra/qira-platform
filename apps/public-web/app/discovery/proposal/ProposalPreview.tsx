...
const BUSINESS_DEMOS: { terms: string[]; demo: BusinessDemoCore }[] = [
  ...
  { terms:["bimbel","les privat","kursus","pelatihan","kelas"], demo:{ name:"Operasional bimbingan belajar", headline:"Siswa, kelas, pengajar, absensi, dan pembayaran tertata bersama.", modules:["Jadwal kelas","Data siswa","Absensi","Tagihan belajar"], metrics:[{label:"Siswa aktif",value:"84"},{label:"Kelas hari ini",value:"7"},{label:"Tagihan jatuh tempo",value:"6"}], flow:["Daftar","Penempatan","Belajar","Evaluasi"] } },
