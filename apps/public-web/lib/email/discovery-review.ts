...
export async function sendClientDiscoveryConfirmationEmail(input: SendClientConfirmationInput) {
  ...
  const { data, error } = await resend.emails.send({
    ...
    subject: `[QIRA] Konfirmasi Pemetaan Kebutuhan Digital • ${input.contact.businessName} (${input.reference})`,
    html: `<div style="font-family:Arial,-apple-system,BlinkMacSystemFont,sans-serif;line-height:1.6;color:#1e293b;max-width:620px;margin:0 auto;padding:24px;border:1px solid #e2e8f0;border-radius:12px;background:#ffffff">
      ...
      <div style="padding:24px 0">
        ...
        <div style="margin:24px 0">
          <a href="${proposalUrl}" style="display:inline-block;background:#2563eb;color:#ffffff;padding:12px 22px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600">Lihat Hasil Pemetaan & Proposal Anda →</a>
        </div>
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:14px 16px;margin:20px 0">
          ...
          <a href="${whatsappUrl}" style="display:inline-block;background:#16a34a;color:#ffffff;padding:8px 16px;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600">Lanjut Diskusi via WhatsApp</a>
        </div>
      ...
      <div style="padding-top:16px;border-top:1px solid #f1f5f9;font-size:12px;color:#94a3b8;text-align:center">
        <p style="margin:0">© 2026 QIRA • <a href="https://www.qirasolution.com" style="color:#2563eb;text-decoration:none">qirasolution.com</a></p>
